...
class Froggo(pygame.sprite.Sprite):
    def __init__(self,position,label,obstacle_sprites,lava_sprites,teleporter_1_sprite,teleporter_2_sprite,teleporter_3_sprite,create_attack,destroy_attack,create_spells):
...
#Game Over screen
            if self.hp <= 0 or self.monster_count==13:
                ...
                if keys[pygame.K_f] and self.switch_score:
                    ...
                    paths = ["../img/froggo/down_idle/idle_down.png","../img/enemies/mushroom/idle/0.png","../img/enemies/bear_dog/idle/0.png","../img/enemies/skeletor/idle/0.png"]
    ...
    def cooldowns(self):
        ...
        #podczas pojedynczego wcisniecia przycisku zmiany magii nie doszlo do wielu 
        #zmian magii jako ze fizycznie wcisniecie przyciska to np okolo 0,2s 
        #co dla komputera oznacza wiele klatek a wiec powtorzenie kodu zmiany magii
        #wiele razy
